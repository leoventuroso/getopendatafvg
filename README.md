...
Opens at `http://localhost:5173`. All map data ships pre-built in `frontend/public/data/` — the frontend runs standalone, no pipeline execution required.
...
| Hydraulic/landslide risk | PAI, regional authority | — | Open Data |
